    ...
    return (
        <div className="md:p-12 p-3">
            <div className='border-2 border-gray-300 md:p-10 p-3 rounded-md bg-slate-200 shadow-lg mb-6'>
                ...
                <p className='text-justify'>React Router is an API for React applications. Most current code is written with React Router 3, although version 4 has been released. React Router uses dynamic routing.
            ...
            <div className='border-2 border-gray-300 md:p-10 p-3 rounded-md bg-slate-200 shadow-lg mb-6'>
                ...
                <p className='text-justify'>The React Context API was been around as an experimental feature for a while now but finally became safe to use in production last year, solving one major problem React problem — prop drilling. In this article, Toptal Freelance Javascript Developer Boris Yordanov will introduce us to the API and illustrate it with two basic web store apps, one built with the Context API and one without it.
                    <br />
            ...
            <div className='border-2 border-gray-300 md:p-10 p-3 rounded-md bg-slate-200 shadow-lg mb-6'>
                ...
                <p className='text-justify'>useRef is one of the standard hooks provided by React. It will return an object that you can use during the whole lifecycle of the component.
