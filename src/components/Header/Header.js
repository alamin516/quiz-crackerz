...
const Header = () => {
    ...
    return (
        <nav className='w-full md:px-16 flex  justify-between border-b-2 shadow-md py-5 px-3'>
            ...
            <div className={`item md:flex justify-center absolute md:static  duration-500 ${open ? 'top-12' : 'top-[-160px]'}`}>
                <Link className='text-2xl mx-6 font-semi-bold' to="/">Home</Link>
                <Link className='text-2xl mx-6 font-semi-bold' to="/statistics">Statistics</Link>
                <Link className='text-2xl mx-6 font-semi-bold' to="/blog">Blog</Link>
            </div>
